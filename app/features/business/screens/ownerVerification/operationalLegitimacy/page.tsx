...
export default function OperationalLegitimacy({
  formData,
  onNext,
  onBack,
  currentStep,
}: Props) {
  const [image, setImage] = useState<string | undefined>(formData.permit_image);
  ...
  return (
    ...
    >
      ...
      <View style={styles.infoCard}>
        <Text style={styles.infoTitle}>Submit either:</Text>
        {["Mayor's Permit", "Business Permit"].map((item) => (
      ...
      <Text style={styles.fieldLabel}>
        Permit Document<Text style={styles.requiredStar}> *</Text>
      </Text>
