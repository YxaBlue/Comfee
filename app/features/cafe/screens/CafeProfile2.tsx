...
const MOCK_CAFE: CafeProfileInformation = {
    ...
    address: "Unit 3, F. Ramos Street, Cogon Ramos, Camputhaw, Cebu City, Central Visayas, 6000, Philippines",
...
const MOCK_POSTS: Post[] = [
    {
        id: "1",
        caption: "New arrivals just in time for the weekend — our Ube Latte and Honey Calamansi Cold Brew. Come try them before they're gone! ☕",
    ...
    {
        id: "2",
        caption: "We're open this Saturday until 8 PM! Stop by for your afternoon coffee fix. 🌤️",
        dateCreated: "2026-01-28",
        imageURL: [
                    ...
                    <View style={reviewCardStyles.imageSubCol}>
                        ...
                        <View style={{ position: "relative" }}>
                            <Image
                                ...
                                style={[reviewCardStyles.imageSub, imageCount > 3 && { opacity: 0.4 }]}
                                resizeMode="cover"
                            />
                            {imageCount > 3 && (
                                <View style={reviewCardStyles.moreOverlay}>
                                    <Text style={reviewCardStyles.moreText}>+{imageCount - 3}</Text>
                                </View>
                            )}
                        </View>
                    </View>
                    ...
                    <View style={postCardStyles.imageGrid3Sub}>
                        ...
                        <View style={{ position: "relative" }}>
                            <Image
                                ...
                                style={[postCardStyles.imageGrid3SubItem, imageCount > 3 && { opacity: 0.4 }]}
                                resizeMode="cover"
                            />
                            {imageCount > 3 && (
        ...
        <View>
            ...
            <View style={infoStyles.statsRow}>
                <View style={infoStyles.statCard}>
                    <Text style={infoStyles.statNum}>{cafe.averageRating.toFixed(1)}</Text>
            ...
            <View style={infoStyles.daysRow}>
                {ALL_DAYS.map((day) => {
                    ...
                    return (
                        ...
                        >
                            <Text style={[infoStyles.dayPillText, !isOpen && infoStyles.dayPillTextClosed]}>
                                {DAY_SHORT[day]}
                            </Text>
                        </View>
                    );
...
function AmenitiesMenuTab({
    ...
    const items: AmenityItemDef[] = [
        ...
        { label: "Power Outlets",   icon: "electrical-services",enabled: amenities.powerOutlets },
        { label: "Parking",         icon: "local-parking",      enabled: amenities.parking },
        { label: "Inside Seating",  icon: "chair",              enabled: amenities.insideSeating },
        { label: "Outside Seating", icon: "deck",               enabled: amenities.outsideSeating },
        { label: "Music",           icon: "music-note",         enabled: amenities.music },
        { label: amenities.light || "Lighting",
                                    icon: "light-mode",         enabled: !!amenities.light },
        { label: amenities.petFriendly || "Pet Friendly",
                                    icon: "pets",               enabled: amenities.petFriendly === "Pet Friendly" },
    ];
    ...
    return (
        <View>
            ...
            <View style={amenityStyles.grid}>
                {items.map((item) => (
                    ...
                    >
                        ...
                        />
                        <Text style={[amenityStyles.itemLabel, !item.enabled && amenityStyles.itemLabelOff]}>
                            {item.label}
                        </Text>
                    </View>
                ))}
            ...
            {amenities.others.length > 0 && (
                <>
                    <Text style={[amenityStyles.sectionLabel, { marginTop: 14 }]}>Other Features</Text>
